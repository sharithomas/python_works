# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 11:20:12 2020

@author: SHARI
"""

#Write a program to toggle nth bit in a binary number.


count_zero=0
binary_num=list()
decimal_num= int(input("enter number"))
position=int(input("position to be toggled"))
...
if binary_num[position-1]==1:
    binary_num[position-1]=0
else:
    binary_num[position-1]=1
print("\n after toggling {})th bit\n".format(position))
for j in range(0,8):
       print(binary_num[j],end="")   
